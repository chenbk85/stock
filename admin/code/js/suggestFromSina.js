	...
	this._0a = function() {
		...
		if (("key_" + _s) in this._Y && this._Y["key_" + _s] != "") {
			...
			for (var i = 0; i < _v; i++) {
				...
				// 去除了onmousedown，防止点击弹出新浪页面
				var _y = this._01["link"] == null || this._01["link"] == "" ? ['<td style="padding:0px;"><span style="display:block; padding:1px;">', '</span></td>'] : ['<td style="padding:0px;"><a href="' + this._01["link"].replace(/@type@/g, this._09(_x[1])).replace(/@code@/g, this._0b(_x)) + '" hidefocus="true" onmousedown="" onclick="return this.parentNode.parentNode.' + _w + '[\'hideresume\'](this);" style="color:#999; display:block; outline:none; padding:1px; text-decoration:none; width:100%;" target="_blank">', '</a></td>'];
				...
				//_t += '<tr id="' + _u[i] + '" style="cursor:pointer;" onmouseover="this.' + _w + '[\'mouseoverLine\'](this);" onmouseout="this.' + _w + '[\'mouseoutLine\'](this);" onmousedown="">';
