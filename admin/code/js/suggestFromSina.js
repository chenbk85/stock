		...
		if ("key_" + a in this._objectData && "" != this._objectData["key_" + a]) {
			...
			for (c = 0; e > c; c++) {
				...
				if (null == this._objectConfig.link || "" == this._objectConfig.link) h = ['<td style="padding:0px;"><span style="display:block; padding:1px;">', "</span></td>"];
					...
					h = ['<td style="padding:0px;"><a href="' + i + '" hidefocus="true" onmousedown="' +  "\" onclick=\"return this.parentNode.parentNode." + f + '[\'hideresume\'](this);" style="color:#999; display:block; outline:none; padding:1px; text-decoration:none; width:100%;" target="' + this._objectConfig.target + '">', "</a></td>"]
